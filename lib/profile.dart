              ...
              Container(
                child: Column(
                  children: <Widget>[
                    ...
                    new  TextField(
                      decoration: InputDecoration(icon: Icon(Icons.email,color: Colors.black54   ),labelText: 'البريد الالكتروني'),
                    ),
                    new  TextField(
                      obscureText: true,
                      decoration: InputDecoration(icon: Icon(Icons.lock,color: Colors.black54   ),labelText: 'كلمة السر'),
                    ),
                    new  TextField(

                      decoration: InputDecoration(icon: Icon(Icons.accessibility,color: Colors.black54   ),labelText: 'عدد الأعضاء'),
                    ),
                    new  TextField(

                      decoration: InputDecoration(icon: Icon(Icons.assignment_ind,color: Colors.black54   ),labelText: 'رقم البطاقة'),
                    ),
                    new SizedBox(
                      height: 15.0,
                    ),
