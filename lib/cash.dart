              ...
              Container(
                child: Column(
                  children: <Widget>[
                    ...
                    new  TextField(
                      decoration: InputDecoration(icon: Icon(Icons.add,color: Colors.black54   ),labelText: 'المحافظة'),
                    ),
                    new  TextField(
                      obscureText: true,
                      decoration: InputDecoration(icon: Icon(Icons.location_city,color: Colors.black54   ),labelText: 'المدينة'),
                    ),
                    new  TextField(

                      decoration: InputDecoration(icon: Icon(Icons.streetview,color: Colors.black54   ),labelText: 'الشارع'),
                    ),
                    new  TextField(
                      keyboardType: TextInputType.phone,
                      textInputAction: TextInputAction.done,
                      decoration: InputDecoration(icon: Icon(Icons.phone,color: Colors.black54   ),labelText: 'رقم الهاتف',
                      ),
                    ),
                    new SizedBox(
                      height: 15.0,
